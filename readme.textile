h4. to jumpstart this main git repo into a local repo of @your choices@.

# @git config --global user.name@ @"Henry Lee"@
# @git config --global user.email@ [@honesthenry@gmail.com@]
# @git clone git://github.com/honestgrace/main.git@ @main@
# @cd@ %{color:blue}@main@% # change directory into your local repo.
...
# push to remote git repo, e.g. [@git push git@github.com:0ishi/main.git@]
...
alias main='cd /Users/henry/github/main' # on mac osx
</pre>
